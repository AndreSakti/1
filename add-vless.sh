...
vlesslink1="vless://${uuid}@bug.com:$tls?path=/vless&security=tls&encryption=none&host=${domain}&type=ws&sni=${domain}#${user}"
vlesslink2="vless://${uuid}@bug.com:$none?path=/vless&security=none&encryption=none&host=${domain}&type=ws#${user}"
vlesslink3="vless://${uuid}@${domain}:$tls?mode=gun&security=tls&encryption=none&host=${domain}&type=grpc&serviceName=vless-grpc&sni=bug.com#${user}"
