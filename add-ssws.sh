...
#buat ss WEBSOCKET
sslinkws="ss://${shadowsocks_base64e}@bug.com:443?path=/ss-ws&security=tls&encryption=none&host=${domain}&type=ws&sni=${domain}#${user}"
nonsslinkws="ss://${shadowsocks_base64e}@bug.com:80?path=/ss-ws&security=none&encryption=none&host=${domain}&type=ws#${user}"

#buat ss GRPC
sslinkgrpc="ss://${shadowsocks_base64e}@${domain}:443?mode=gun&security=tls&encryption=none&host=${domain}&type=grpc&serviceName=ss-grpc&sni=bug.com#${user}"
nonsslinkgrpc="ss://${shadowsocks_base64e}@${domain}:80?mode=gun&security=none&encryption=none&host=${domain}&type=grpc&serviceName=ss-grpc&sni=bug.com#${user}"
...
END
cat > /home/vps/public_html/sodosokwsl-$user.txt <<-END
{ 
 "dns": {
    "servers": [
      "8.8.8.8",
...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo -e "Link JSON WS TLS : http://${domain}:81/sodosokws-$user.txt" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo -e "Link JSON WS None TLS : http://${domain}:81/sodosokwsl-$user.txt" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
echo -e "Link JSON gRPC TLS : http://${domain}:81/sodosokgrpc-$user.txt" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-user.log
